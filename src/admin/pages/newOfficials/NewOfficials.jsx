...
import { Button, TextField, IconButton, InputAdornment, Card } from '@mui/material';
...
const NewOfficials = () => {
  ...
  const handleSubmit = async () => {
    if (!validateForm() || loading) return; // Prevent submission if loading or invalid
    ...
    try {
      ...
      if (error) {
        ...
        toast.success("Official registered successfully! Please complete email verification.");
